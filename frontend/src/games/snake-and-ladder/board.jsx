              ...
              <div className="relative w-full h-full border-[3px] border-black rounded overflow-hidden bg-white shadow-[inset_2px_2px_0px_rgba(0,0,0,0.1)]">
                ...
                {gameState.players.map(p => {
                  ...
                  return (
                    <div 
                      key={p.id} 
                      className="absolute rounded-full border-[3px] border-white z-20 transition-all duration-300 ease-in-out shadow-[0px_0px_8px_rgba(0,0,0,0.8)]"
                      style={{ 
                        width: 'clamp(22px, 4vw, 32px)', 
                        height: 'clamp(22px, 4vw, 32px)', 
                        backgroundColor: p.color, 
                        left: `calc(${coords.x}% - 11px)`, 
                        top: `calc(${coords.y}% - 11px)` 
                      }}
                    />
                  );
                })}
