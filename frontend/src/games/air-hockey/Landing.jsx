...
export default function AirHockeyLanding() {
  ...
  const handleCreate = async () => {
    ...
    // Emit room creation with the specific gameType[cite: 5]
    ...
    // Navigate to the Air Hockey room[cite: 5]
    navigate(`/games/air-hockey/room/${result.room.code}`, { state: { room: result.room } });
  };
  ...
  return (
    <div className="max-w-xl mx-auto px-5 py-12 sm:py-16">
      <div className="text-center mb-10">
        <div className="sketch-border inline-flex items-center justify-center w-[clamp(4rem,10vw,6rem)] aspect-square bg-blue-300 mb-6 overflow-hidden -rotate-2">
          {/* Replace this with an Air Hockey thumbnail */}
          <img
            src="/images/airhockey.png"
            alt="Air Hockey Preview"
            className="w-full h-full object-cover p-2"
          />
        </div>

        <h2 className="text-[clamp(1.75rem,5vw,3rem)] font-black uppercase mb-3 text-ink">
          <div className="inline-block rotate-[-1deg]">
            <div className="bg-sky-300 border-[3px] border-black px-6 py-3 shadow-[6px_6px_0px_#000]">
        ...
        <p className="text-[clamp(1rem,2vw,1.25rem)] text-gray-800 font-bold">Slide, strike, and score!</p>
      </div>
